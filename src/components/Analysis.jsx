...
export default function Analysis(){
  ...
  return (
    <div className="grid grid-3">
      ...
      <div className="card" style={{gridColumn:"1 / -1"}}><h3>Running Balance</h3><RunningBalance data={a.running} /></div>
      <div className="card"><h3>Top Tags</h3>
        <ul>
          {a.topTags.map(t=> <li key={t.name}>{t.name} - {t.count}</li>)}
        </ul>
      </div>
      <div className="card"><h3>Recurring vs Non-Recurring</h3>
